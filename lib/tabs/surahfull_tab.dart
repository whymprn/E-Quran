...
class SurahFullTab extends StatelessWidget {
  const SurahFullTab({super.key});

  Future<List<Surah>> _getSurahFullList() async {
    ...
    return FutureBuilder<List<Surah>>(
        ...
        builder: ((context, snapshot) {
          ...
          return ListView.separated(
              itemBuilder: (context, index) => _surahFullItem(
  ...
  Widget _surahFullItem({required Surah surah, required BuildContext context}) =>
      GestureDetector(
        behavior: HitTestBehavior.opaque,
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => SurahFullScreen(
                    noSurat: surah.nomor,
                  )));
        },
        child: Padding(
